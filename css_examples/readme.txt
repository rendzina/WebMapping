Cascading Style Sheets - some examples
======================================
...
Images.htm
----------
Images.htm is designed to show how you can truly seperate content from design. Load the html file up and observe the visual interface - menus appear to have 'rollover images', text is positioned etc. Now look at the source code of the HTML - where are the references for these images? They are not in the HTML - the HTML looks really simple - again split up using DIV tags. The CSS file itself contains references to the images - load up the 'images_screen.css' CSS file to see how this is done. Imagine the advantages of keeping the design seperate from the text content! It makes the HTML code really clear and easy to maintain - it could be easily generated from a database even. Then as for styles, you could have a series of different styles which can be applied to the same content - you could even give your visitor the choice of how to view it! Do have a look at http://www.csszengarden.com/ to see far better examples - although the principle is the same.